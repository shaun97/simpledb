...
public class Term {
   ...
   //// New constructor (Lab 1)
   /**
    * Create a new term that compares two expressions
    * for equality.
    * @param lhs  the LHS expression
    * @param rhs  the RHS expression
    * @param op the comparator
    */
   ...
   /**
    * Return true if the term's expressions
    * satisfy the comparator.
    * @param s the scan
    * @return true if the expressions satisfies the comparator
    */
